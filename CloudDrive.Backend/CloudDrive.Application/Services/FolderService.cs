...
namespace CloudDrive.Application.Services
{
    public class FolderService : IFolderService
    {
        ...
        public async Task<Folder> AddFolderAsync(AddFolderDto folderDto, CancellationToken token)
        {
        ...
        public async Task DeleteFolderAsync(Guid folderId, CancellationToken token)
        {
            bool flag = await _repo.DeleteByIdAsync(folderId, token);
            if (!flag)
            {
        ...
        public async Task<UpdateFolderDto> UpdateFolderAsync(UpdateFolderDto folderDto, CancellationToken token)
        {
            ...
            var updatedFolder = await _repo.UpdateAsync(updatefolder, token);
